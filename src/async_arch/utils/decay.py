...
class LinearDecay:
    ...
    milestones :
        ...
        E.g. [(0, 100), (1000, 50)] means for step <= 0 use value 100, between
        step 0 and 1000 interpolate the value between 100 and 50, then keep at
        50 forever.
    staircase :
        int
        If None then no rounding is applied.
        If int then the value will move one "stair" at a time (if staircase=10,
        then value will be: 100, 90, 80, ...)
