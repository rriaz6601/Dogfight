...
class XPlaneComms(object):
    """XPlaneComms facilitates communication to and from the XPlane plugin for communication."""

    socket = None

    # Basic Functions
    def __init__(self, xpHost="localhost", xpPort=49009, port=0, timeout=100):
        """Sets up a new connection to an X-Plane plugin running in X-Plane.

        Args:
          xpHost: The hostname of the machine running X-Plane.
          xpPort: The port on which the XPlane plugin is listening. Usually 49007.
    ...
    def pauseSim(self, pause):
        ...
        ----------
        pause :
            True to pause the simulation; False to resume.
    ...
    def sendDATA(self, data):
        ...
        ----------
        data :
            An array of values representing data rows to be set. Each array in `data`
    ...
    def getPOSI(self, ac=0):
        ...
        ----------
        ac :
            The aircraft to get the position of. 0 is the main/player aircraft. (Default value = 0)
    ...
    def sendPOSI(self, values, ac=0):
        ...
        ----------
        values :
            The position values to set. `values` is a array containing up to
            ...
            * Gear (0=up, 1=down)
        ac :
            The aircraft to set the position of. 0 is the main/player aircraft. (Default value = 0)
    ...
    def getCTRL(self, ac=0):
        ...
        ----------
        ac :
            The aircraft to get the control surfaces of. 0 is the main/player aircraft. (Default value = 0)
    ...
    def sendCTRL(self, values, ac=0):
        ...
        values :
            ...
            * Speedbrakes [-0.5, 1.5]
        ac :
            The aircraft to set the control surfaces of. 0 is the main/player aircraft. (Default value = 0)
    ...
    def sendDREF(self, dref, values):
        ...
        ----------
        dref :
            The name of the datarefs to set.
        values :
            Either a scalar value or a sequence of values.
    ...
    def sendDREFs(self, drefs, values):
        ...
        ----------
        drefs :
            A list of names of the datarefs to set.
        values :
            A list of scalar or vector values to set.
    ...
    def getDREF(self, dref):
        ...
        ----------
        dref :
            The name of the dataref to get.
    ...
    def sendTEXT(self, msg, x=-1, y=-1):
        ...
        x :
            The distance in pixels from the left edge of the screen to display the
            message. A value of -1 indicates that the default horizontal position should
            be used.
        y :
            The distance in pixels from the bottom edge of the screen to display the
    ...
    def sendVIEW(self, view):
        ...
        ----------
        view :
            The view to use. The ViewType class provides named constants
            for known views.
    ...
    def sendWYPT(self, op, points):
        ...
        ----------
        op :
            The operation to perform. Pass `1` to add waypoints,
            `2` to remove waypoints, and `3` to clear all waypoints.
        points :
            A sequence of floating point values representing latitude, longitude, and
